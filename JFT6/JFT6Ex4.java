...
/*
Create a Java program to model the basic workings of an ATM machine. Use an if-else statement
to determine if a cash withdrawal can be made.
        ...
        while (true){
            ...
            if (inputStr.equals("sair")){
                ...
                if (acc.verifySufficientBalance(retirada)){
                    System.out.println("O valor de " + retirada + " está disponível para retirada.");
                    ...
                    System.out.println("O valor excede o limite disponível para saque.");
                }
